...
This is really usefull when you want to just allow certain customers access to more advanced features.
...
To hide content in frontend, wrap your component with the provided *NBAccessControlComponent*
...
:::tip
The NBAccessControlComponent can both be used to show / hide content or restrict a route. It can also restrict roles. See the built in documentation in react.
:::
...
Use the resourceMappings.json to restrict a http endpoint or resolver to a certain plan. Here we say that the dashboard endpoint requires users to have plan PREMIUM and AUTHENTICATED privilege.
