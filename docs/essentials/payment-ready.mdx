...
To hide content in frontend, wrap your component with the provided PlanAccessControllComponent.
...
Use the resourceMappings.json to restrict a http endpoint or resolver to a certain plan. Here we say that the dashboard endpoint requires users to have plan PREMIUM and ANALYTICS_READ privilege.
