...
Nblocks is using sensible defaults to development and integrations simpler. 
To use another application address you need to change your app profile configuration.

**Step 1. Open `app-configuration.json`.**   
This was downloaded when you signed up Nblocks through terminal.
...
**Step 3. Save the changes by uploading the updated configuration**
```console
