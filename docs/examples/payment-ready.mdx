...
# Getting payment ready with Stripe
...
For this example we're going to create two *plans*: one free named "FREEMIUM" and one paid named "PREMIUM".
Payments will be made in Euro and charged should recurr monthly. These details needs to be put together into a JSON format and stored on your app model.
