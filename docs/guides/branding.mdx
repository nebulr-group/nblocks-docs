...
# Branding
Flexible branding has been a top priority for us and Nblocks let you apply your own brand to your app. This applies to all aspects like colors, logos, wordings, emailing etc. Learn how to setup your app with your own custom branding.
...
One of the styles you added to `angular.json` during the quickstart intro represent the PrimeNG theme. You can change this to any of the 30+ available themes.
...
## App variables
Using our backend plugins or not, Nblocks have already stored an App model wich is up to you to change.
...
| emailSenderName   | This will be sender name in all Nblocks emails |
| emailSenderEmail  | This will be sender email in all Nblocks emails. You'll have to verify this email address before being able to use it |
...
Only after you've verified that you're the rightful owner of the email addres will Nblocks use it.
