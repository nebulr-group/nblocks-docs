...
# Branding
Learn how to setup your app with your own custom branding.
...
* [**App variables**](#app-variables) like App name, logo src etc that Nblocks will use in all interactions with your users. This data is stored on your app model in the NBlocks platform.
