...
You'll be able to get hold of an client instance straight, all prepped with credentails, from your plug-n-play plugin.
...
### Reference
The API client wraps all functionality from the nBlocks Rest API. See our [API Reference](https://reference.nblocks.io) for exact usage.
...
4. List all tenants in your app
```javascript
