...
:::tip What is RBAC?
Role-Based Access Control (RBAC) is a mechanism that restricts system access. The user will gain access to certain parts of the system depending on which roll the user have. If you want to read more about RBAC click [here](https://en.wikipedia.org/wiki/Role-based_access_control).
:::
