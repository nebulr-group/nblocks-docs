...
@Module({
  imports: [
    ...
    // Add new import for NBlocksModule
    NBlocksModule
    ...
  ],
})
...
"styles": [
  ...
  // The next block of styles should be added
...
@NgModule({
  ...
  imports: [
    ...
    // Add new import for NblocksIonicModule
    NblocksIonicModule.forRoot({})
  ],
  providers: [
    ...
    // Add new record for interceptor providers
...
- Go full hard core and checkout the [API client](concepts/api-client.mdx) and [API reference](https://nebulr-group.github.io/nblocks-api-docs).
