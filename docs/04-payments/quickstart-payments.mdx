...
We will code a component that will redirect the user to the Nblocks hosted Select plan view and add a button so that a user can manage their subscription.
