...
Among enterprise customers, IT admins and managers should be able to control who gets access to your app directly from their own identity management system. To support this you need to implement one of the enterprise login protocols using the Nblocks Enterprise Login.
