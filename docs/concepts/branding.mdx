...
You can update your app model with the built in Nblocks SDK client, Postman, Curl or any HTTP POST tool. 
Below we use the built in Nblocks SDK client that can be obtained via the plugin.
<Tabs>
