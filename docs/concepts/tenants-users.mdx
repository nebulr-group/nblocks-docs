...
Tenants get created automatically in Nblocks if you've using our [payment ready](/docs/essentials/payment-ready) solution. 
...
| -----------       | ----------- |
| id                | Unique ID |
| role              | Role of the user. Grants a set of privileges. Privileges are configured on the `App` model. See [security](/docs/concepts/security).|
| email             | Email address |
...
:::tip
Read more about users and how to secure access to your application based on their privileges [here](/docs/concepts/security).
:::
