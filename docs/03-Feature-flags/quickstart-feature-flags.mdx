...
Think of this as you'd want to target an individual tenant / workspace, user or a group of roles. That's what Segments are for. 
...
### Step 3. Attach the segmentent to the flag
...
But we've simplified it using a base structure so you can build segments in Nblocks Admin more easily.
