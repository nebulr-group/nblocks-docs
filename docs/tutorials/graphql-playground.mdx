...
Right after finishing [quickstart](/docs/essentials/quickstart) we've made it so you got access to a web based editor playground to query and mutate the GraphQL endpoints. 
