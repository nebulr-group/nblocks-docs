...
* See best practises how to use tokens to protect your [frontend](/docs/authentication-and-access/protect-frontend) or [backend](/docs/authentication-and-access/protect-backend).
