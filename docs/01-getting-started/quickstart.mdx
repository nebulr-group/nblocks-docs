...
Create a new class that we call `Callback` and add this to the `/auth/oauth-callback` route. In Java, routes can be created in a **Jetty** web server.

```java title=src/main/java/com/mycompany/app/Callback.java
package com.mycompany.app;
