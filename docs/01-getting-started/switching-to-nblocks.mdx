...
## Importing workspaces via Nblocks Admin
1. Go to [Nblocks Admin](https://admin-stage.nblocks.cloud) and login.
...
4. Upload a CSV or XLXS file containing your existing users and workspaces. An example file is available to download as reference.
...
## Importing workspaces via Rest API
How to import workspaces via Rest API is described [here](https://nebulr-group.github.io/nblocks-api-docs/#import-data)